...
<div id="login-dialog" class="dialog" style="display: block;">
    <div class="bg"></div>
    <div class="content">
        ...
        <div class="body">
            ...
            <div class="form login clearfix">
                <form class="login" action="/users/sign_in" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="PL9eyrM7gZuIj/8GxzczLzqQ8Wb+Qg4FzCN31vCJ/o6vqpKyzVNtVa4Tscl1UFrp1N2EUwL57utZZXdPYtpyxg==">
                    <input class="input-control phone" placeholder="手机号" type="text" name="session[phone]" id="session_phone">
                    <input class="input-control password" placeholder="密码" type="password" name="session[password]" id="session_password">
...
<div id="middle-reg-dialog" class="dialog" style="display: none;">
    ...
    <div class="content">
        ...
        <div class="body">
            ...
            <div class="form reg">
                <form class="reg" action="/users" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="✓"><input type="hidden" name="authenticity_token" value="PL9eyrM7gZuIj/8GxzczLzqQ8Wb+Qg4FzCN31vCJ/o6vqpKyzVNtVa4Tscl1UFrp1N2EUwL57utZZXdPYtpyxg==">
                    <input class="input-control name" placeholder="昵称" type="text" name="registrations[name]" id="registrations_name">
                    <input class="input-control password" placeholder="密码" type="password" name="registrations[password]" id="registrations_password">
                    <input class="input-control password_confirmation" placeholder="重复密码" type="password" name="registrations[password_confirmation]" id="registrations_password_confirmation">
                    <input type="hidden" name="registrations[phone]" id="registrations_phone">
                    <input type="hidden" name="registrations[user_beens]" id="registrations_user_beens">
                    <input type="hidden" name="registrations[user_likes]" id="registrations_user_likes">
                    <div class="form-controls">
