  ...
  <div class="col-auto">
    <div class="table_full">
      <table class="table table-bordered">
            ...
            <tr>
              <th width="80">目的地</th>
              <td><input type='text' name='post[post_keywords]' id='keywords' value='' style='width:400px'   class='input' placeholder='请输入目的地'> 多目的地之间用空格或者英文逗号隔开</td>
            </tr>
            <tr>
              <th width="80">人均花费</th>
              <td><input type='text' name='post[post_source]' id='source' value='' style='width:200px'   class='input' placeholder='请输入人均花费'>元/人</td>
            </tr>
		  <tr>
			  <th width="80">游玩时间</th>
			  <td><input type='text' name='post[day]' id='day' value='7' style='width:200px'   class='input' placeholder='请输入游玩天数'>天</td>
		  </tr>
		  <tr>
			  <th width="80">游玩人数</th>
			  <td><input type='text' name='post[people_num]' id='people_num' value='1' style='width:200px'   class='input' placeholder='请输入游玩人数'>人</td>
		  </tr>
            <tr>
              <th width="80">摘要 </th>
