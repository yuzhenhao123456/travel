...
CREATE TABLE IF NOT EXISTS `y_ad` (
...
CREATE TABLE IF NOT EXISTS `y_asset` (
...
CREATE TABLE IF NOT EXISTS `y_auth_access` (
...
CREATE TABLE IF NOT EXISTS `y_auth_rule` (
...
INSERT INTO `y_auth_rule` (`id`, `module`, `type`, `name`, `param`, `title`, `status`, `condition`) VALUES
...
CREATE TABLE IF NOT EXISTS `y_comments` (
...
--
-- 表的结构 `y_common_action_log`
--

CREATE TABLE IF NOT EXISTS `y_common_action_log` (
...
CREATE TABLE IF NOT EXISTS `y_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `y_links` (
...
CREATE TABLE IF NOT EXISTS `y_menu` (
...
INSERT INTO `y_menu` (`id`, `parentid`, `app`, `model`, `action`, `data`, `type`, `status`, `name`, `icon`, `remark`, `listorder`) VALUES
...
INSERT INTO `y_nav` (`id`, `cid`, `parentid`, `label`, `target`, `href`, `icon`, `status`, `listorder`, `path`) VALUES
...
CREATE TABLE IF NOT EXISTS `y_nav_cat` (
...
INSERT INTO `y_nav_cat` (`navcid`, `name`, `active`, `remark`) VALUES
(1, '主导航', 1, '主导航');
...
CREATE TABLE IF NOT EXISTS `y_oauth_user` (
...
CREATE TABLE IF NOT EXISTS `y_options` (
...
INSERT INTO `y_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
...
CREATE TABLE IF NOT EXISTS `y_plugins` (
...
CREATE TABLE IF NOT EXISTS `y_posts` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `y_role` (`id`, `name`, `pid`, `status`, `remark`, `create_time`, `update_time`, `listorder`) VALUES
...
CREATE TABLE IF NOT EXISTS `y_role_user` (
...
CREATE TABLE IF NOT EXISTS `y_route` (
...
CREATE TABLE IF NOT EXISTS `y_slide` (
...
CREATE TABLE IF NOT EXISTS `y_slide_cat` (
...
CREATE TABLE IF NOT EXISTS `y_terms` (
...
INSERT INTO `y_terms` (`term_id`, `name`, `slug`, `taxonomy`, `description`, `parent`, `count`, `path`, `seo_title`, `seo_keywords`, `seo_description`, `list_tpl`, `one_tpl`, `listorder`, `status`) VALUES
(1, '案例故事', '', 'article', '', 0, 0, '0-1', '', '', '', 'list', 'article', 0, 1),
(2, '非案例故事', '', 'article', '', 0, 0, '0-2', '', '', '', 'list_masonry', 'article', 0, 1);

-- --------------------------------------------------------

--
-- 表的结构 `y_term_relationships`
--

CREATE TABLE IF NOT EXISTS `y_term_relationships` (
...
INSERT INTO `y_users` (`id`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `avatar`, `sex`, `birthday`, `signature`, `last_login_ip`, `last_login_time`, `create_time`, `user_activation_key`, `user_status`, `score`, `user_type`) VALUES
(1, 'admin', 'ff108b961a8421232f297a57a5a743894a0e4a801fc36f8e', 'admin', '260658065@qq.com', '', NULL, 0, NULL, NULL, '127.0.0.1', '2015-10-27 00:34:09', '2015-09-26 06:17:41', '', 1, 0, 1);

-- --------------------------------------------------------

--
-- 表的结构 `y_user_favorites`
--

CREATE TABLE IF NOT EXISTS `y_user_favorites` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
